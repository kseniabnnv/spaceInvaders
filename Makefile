...
$(exe_file): main.o game.o textureContainer.o
	g++ main.o game.o textureContainer.o -o $(exe_file) -LC:/SFML-2.6.1/lib -lsfml-graphics-s -lsfml-window-s -lsfml-system-s -lopengl32 -lfreetype -lwinmm -lgdi32 -mwindows
main.o: main.cpp
